                        ...
                        <div class="ps-banner__block">
                            <div class="ps-banner__content">
                                ...
                                <div class="ps-banner__btn-group">
                                    ...
                                    <div class="ps-banner__btn"><img src="img/icon/virus.svg" alt="alt">Anti-Virus
                                    </div>
                                </div><a class="bg-warning ps-banner__shop" href="#">Shop now</a>
        ...
        <div class="ps-home__content">
                ...
                <section class="ps-section--category">
                    ...
                    <div class="ps-category--block">
                        ...
                        <div class="ps-category__thumbnail"> <a class="ps-category__image" href="category-grid.html"><img
                            ...
                            <div class="ps-category__content"><a class="ps-category__name"
                                    href="category-grid.html">Blood pressure</a><a class="ps-category__more"
                                    href="category-grid.html">More</a></div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="owl-carousel" data-owl-auto="false" data-owl-loop="true" data-owl-speed="13000"
                            ...
                            <div class="ps-section__product">
                                <div class="ps-product ps-product--standard">
                                    ...
                                    <div class="ps-product__content">
                                        <h5 class="ps-product__title"><a href="product1.html">Multi hook retractor
                                                surgical spinal retractors</a></h5>
                            ...
                            <div class="ps-section__product">
                                <div class="ps-product ps-product--standard">
                                    ...
                                    <div class="ps-product__content">
                                        <h5 class="ps-product__title"><a href="product1.html">3-Ply Ear-Loop Disposable
                                                Blue Face Mask</a></h5>
                                        <div class="ps-product__meta"><span
                                ...
                                <div class="ps-product ps-product--standard">
                                    ...
                                    <div class="ps-product__content">
                                        <h5 class="ps-product__title"><a href="product1.html">Blue Hot Water Bottle, 2
                                                Quart Capacity</a></h5>
                                        <div class="ps-product__meta"><span class="ps-product__price">$14.52 -
                                                $15.52</span>
                                        </div>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                ...
                                <div class="owl-carousel" data-owl-auto="false" data-owl-loop="true"
                                    ...
                                    <div class="ps-section__product">
                                        <div class="ps-product ps-product--standard">
                                            ...
                                            <div class="ps-product__content">
                                                <h5 class="ps-product__title"><a href="product1.html">Home Blood
                                                        Pressure Monitors</a></h5>
                                                <div class="ps-product__meta"><span
                                                        class="ps-product__price sale">$90.65</span><span
                                                        class="ps-product__del">$60.65</span>
                                                </div>
                                    ...
                                    <div class="ps-section__product">
                                        <div class="ps-product ps-product--standard">
                                            ...
                                            <div class="ps-product__content">
                                                <h5 class="ps-product__title"><a href="product1.html">Blood Pressure
                                                        Monitor with Stroke Risk Detection</a></h5>
                                                <div class="ps-product__meta"><span
                                                        class="ps-product__price sale">$77.65</span><span
                                                        class="ps-product__del">$80.65</span>
                                                </div>
                                    ...
                                    <div class="ps-section__product">
                                        <div class="ps-product ps-product--standard">
                                            ...
                                            <div class="ps-product__content">
                                                <h5 class="ps-product__title"><a href="product1.html">Technical
                                                        Classicpod Micro Stethoscope Case</a></h5>
                                ...
                                <div class="owl-carousel" data-owl-auto="false" data-owl-loop="true"
                                    ...
                                    <div class="ps-section__product">
                                        <div class="ps-product ps-product--standard">
                                            ...
                                            <div class="ps-product__content">
                                                <h5 class="ps-product__title"><a href="product1.html">Disposable Face
                                                        Mask for Unisex</a></h5>
                                                <div class="ps-product__meta"><span
                                                        class="ps-product__price sale">$20.39</span><span
                                                        class="ps-product__del">$8.15</span>
                                                </div>
                                    ...
                                    <div class="ps-section__product">
                                        <div class="ps-product ps-product--standard">
                                            ...
                                            <div class="ps-product__content">
                                                <h5 class="ps-product__title"><a href="product1.html">3-layer mask with
                                ...
                                <div class="owl-carousel" data-owl-auto="false" data-owl-loop="true"
                                    ...
                                    <div class="ps-section__product">
                                        <div class="ps-product ps-product--standard">
                                            ...
                                            <div class="ps-product__content">
                                                <h5 class="ps-product__title"><a href="product1.html">Somersung Sonic
                                                        X2500 Pro White</a></h5>
                                                <div class="ps-product__meta"><span
                                                        class="ps-product__price">$39.99</span>
                                                </div>
                                                <div class="ps-product__rating">
                                                    <select class="ps-rating" data-read-only="true">
                                                        <option value="1">1</option>
                                        ...
                                        <div class="ps-product ps-product--standard">
                                            ...
                                            <div class="ps-product__content">
                                                <h5 class="ps-product__title"><a href="product1.html">Extractor used to
                                                        remove teeth</a></h5>
                                                <div class="ps-product__meta"><span
                                                        class="ps-product__price">$53.64</span>
                                                </div>
                                                <div class="ps-product__rating">
                                                    <select class="ps-rating" data-read-only="true">
                                                        <option value="1">1</option>
                                        ...
                                        <div class="ps-product ps-product--standard">
                                            ...
                                            <div class="ps-product__content">
                                                <h5 class="ps-product__title"><a href="product1.html">Hill-Rom P8000
                                                        Stretcher</a></h5>
                                                <div class="ps-product__meta"><span
                                                        class="ps-product__price">$511.64</span>
                                                </div>
                                                <div class="ps-product__rating">
                                                    <select class="ps-rating" data-read-only="true">
                                                        <option value="1">1</option>
                                        ...
                                        <div class="ps-product ps-product--standard">
                                            ...
                                            <div class="ps-product__content">
                                                <h5 class="ps-product__title"><a href="product1.html">Hill-Rom
                                                        VersaCare</a></h5>
                                                <div class="ps-product__meta"><span
                                                        class="ps-product__price">$136.87</span>
                                                </div>
                                                <div class="ps-product__rating">
                                                    <select class="ps-rating" data-read-only="true">
                                                        <option value="1">1</option>
                            ...
                            <div class="col-6 col-md-4 col-lg-2dot4 p-0">
                                <div class="ps-section__product">
                                    <div class="ps-product ps-product--standard">
                                        ...
                                        <div class="ps-product__content">
                                            <h5 class="ps-product__title"><a href="product1.html">Blue Hot Water Bottle,
                            ...
                            <div class="col-6 col-md-4 col-lg-2dot4 p-0">
                                <div class="ps-section__product">
                                    <div class="ps-product ps-product--standard">
                                        ...
                                        <div class="ps-product__content">
                                            <h5 class="ps-product__title"><a href="product1.html">Mild Binocular
                                                    Compound Light Microscope</a></h5>
                                            <div class="ps-product__meta"><span
                                    ...
                                    <div class="ps-product ps-product--standard">
                                        ...
                                        <div class="ps-product__content">
                                            <h5 class="ps-product__title"><a href="product1.html">Lens Frame
                                                    Professional Adjustable Multifunctional</a></h5>
                                            <div class="ps-product__meta"><span
            ...
            <div class="container">
                <section class="ps-section--instagram">
                    ...
                    <div class="ps-section__content">
                        <div class="row m-0">
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition"
                                    href="https://www.instagram.com/p/CDf7FC7pwae/"> <img
                                        src="img/instagram/instagram1.jpg" alt=""><span
                                        class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition"
                                    href="https://www.instagram.com/p/CDf7D5zJqwo/"> <img
                                        src="img/instagram/instagram2.jpg" alt=""><span
                                        class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition"
                                    href="https://www.instagram.com/p/CDf7BnapGmv/"> <img
                                        src="img/instagram/instagram3.jpg" alt=""><span
                                        class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition"
                                    href="https://www.instagram.com/p/CDf7Af8JWDj/"> <img
                                        src="img/instagram/instagram4.jpg" alt=""><span
                                        class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition"
                                    href="https://www.instagram.com/p/CDf6_QEpWYv/"> <img
                                        src="img/instagram/instagram5.jpg" alt=""><span
                                        class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition"
                                    href="https://www.instagram.com/p/CDf69FupFee/"> <img
                                        src="img/instagram/instagram6.jpg" alt=""><span
                                        class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                        </div>
                    </div>
                </section>
