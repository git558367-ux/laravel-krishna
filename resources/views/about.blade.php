                    ...
                    <div class="ps-banner" style="background:#DAECFA;">
                        <div class="container container-initial">
                            <div class="ps-banner__block">
                                ...
                                <div class="ps-banner__thumnail"><img class="ps-banner__round" src="img/round2.png" alt="alt"><img class="ps-banner__image" src="img/promotion/slide1.png" alt="alt">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ps-banner" style="background:#FFCC00;">
                        <div class="container container-initial">
                            <div class="ps-banner__block">
                                ...
                                <div class="ps-banner__thumnail"><img class="ps-banner__round" src="img/round2.png" alt="alt"><img class="ps-banner__image" src="img/promotion/slide4.png" alt="alt">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="ps-promo ps-not-padding">
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="ps-promo__item"><img class="ps-promo__banner" src="img/promotion/bg-banner1.jpg" alt="alt">
                                    <div class="ps-promo__content"><span class="ps-promo__badge">New</span>
                                        <h4 class="mb-20 ps-promo__name">Vaprorizer <br>Charger <br>X200 5KW</h4><a class="ps-promo__btn" href="category-grid.html">More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="ps-promo__item"><img class="ps-promo__banner" src="img/promotion/bg-banner2.jpg" alt="alt">
                    ...
                    <section class="ps-section--category">
                        ...
                        <div class="ps-category--block">
                            <div class="ps-category__thumbnail"> <a class="ps-category__image" href="category-grid.html"><img src="img/promotion/facemask-cat.png" alt=""></a>
                            ...
                            <div class="ps-category__thumbnail"> <a class="ps-category__image" href="category-grid.html"><img src="img/promotion/uniforms-cat.png" alt=""></a>
                            ...
                            <div class="ps-category__thumbnail"> <a class="ps-category__image" href="category-grid.html"><img src="img/promotion/protectcover-cat.png" alt=""></a>
                            ...
                            <div class="ps-category__thumbnail"> <a class="ps-category__image" href="category-grid.html"><img src="img/promotion/dental-cat.png" alt=""></a>
                            ...
                            <div class="ps-category__thumbnail"> <a class="ps-category__image" href="category-grid.html"><img src="img/promotion/pressure-cat.png" alt=""></a>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4 col-lg-2">
                                <div class="ps-category__nav">
                                    <div class="ps-category__title">Wound Care</div>
                            ...
                            <div class="col-6 col-md-4 col-lg-2">
                                <div class="ps-category__nav">
                                    <div class="ps-category__title">Higiene</div>
                                    <ul class="ps-category__list">
                            ...
                            <div class="col-6 col-md-4 col-lg-2">
                                <div class="ps-category__nav">
                                    <div class="ps-category__title">Laboratory</div>
                                    <ul class="ps-category__list">
                                        <li><a href="category-grid.html">Accessories</a></li>
                            ...
                            <div class="col-6 col-md-4 col-lg-2">
                                <div class="ps-category__nav">
                                    <div class="ps-category__title">Tools</div>
                                    <ul class="ps-category__list">
                            ...
                            <div class="col-6 col-md-4 col-lg-2">
                                <div class="ps-category__nav">
                                    <div class="ps-category__title">Diagnosis</div>
                                    <ul class="ps-category__list">
                                        <li><a href="category-grid.html">Accessories</a></li>
                            ...
                            <div class="col-6 col-md-4 col-lg-2">
                                <div class="ps-category__nav">
                                    <div class="ps-category__title">Equipment</div>
                                    <ul class="ps-category__list">
                            ...
                            <div class="owl-carousel" data-owl-auto="false" data-owl-loop="true" data-owl-speed="13000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="5" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="5" data-owl-item-xl="5" data-owl-duration="1000" data-owl-mousedrag="on">
                                <div class="ps-section__product">
                                    <div class="ps-product ps-product--standard">
                                        ...
                                        <div class="ps-product__content">
                                            <h5 class="ps-product__title"><a href="product1.html">Multi hook retractor surgical spinal retractors</a></h5>
                                            <div class="ps-product__meta"><span class="ps-product__price sale">$65.39</span><span class="ps-product__del">$48.99</span>
                                            </div>
                                            <div class="ps-product__rating">
                                                <select class="ps-rating" data-read-only="true">
                                                    <option value="1">1</option>
                                ...
                                <div class="ps-section__product">
                                    <div class="ps-product ps-product--standard">
                                        ...
                                        <div class="ps-product__content">
                                            <h5 class="ps-product__title"><a href="product1.html">Generic Stethoscope Hearing Heartbeat Tool</a></h5>
                                            <div class="ps-product__meta"><span class="ps-product__price sale">$53.75</span><span class="ps-product__del">$38.24</span>
                                            </div>
                                            <div class="ps-product__rating">
                                                <select class="ps-rating" data-read-only="true">
                                                    <option value="1">1</option>
