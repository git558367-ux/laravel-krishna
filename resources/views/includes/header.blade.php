                ...
                <ul class="ps-header__icons">
                    ...
                    <li>
                        ...
                        <div class="ps-login--modal">
                            ...
                            @guest
                                <a href="{{ route('login') }}" class="ps-btn ps-btn--warning mb-2">
                                    Login
                                </a>
                                <a href="{{ route('register') }}" class="ps-btn ps-btn--primary">
                                    Register
                                </a>
                            @endguest
                        </div>
                    ...
                    <li><a class="ps-header__item" href="{{ route('cart.index') }}" id="cart-mini"><i class="icon-cart-empty"></i><span
        ...
        <div class="container">
            <div class="ps-navigation__left">
                <nav class="ps-main-menu">
                    <ul class="menu">
                        <li class="has-mega-menu"><a href="{{ route('all.products') }}"> <i
                                    class="fa fa-bars"></i>Products</a>

                        </li>
                        <li class="has-mega-menu"><a href="#"> Home Medical Supplies</a>

                        </li>
                        <li class="has-mega-menu"><a href="#"> Homepages</a>

                        </li>
                        <li class="has-mega-menu"><a href="category-list.html">Shop</a></li>
                        <li class="has-mega-menu"><a href="#"> Pages</a>

                        </li>
                        <li class="has-mega-menu"><a href="#"> Collection</a>
