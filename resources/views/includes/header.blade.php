            ...
            <div class="ps-navigation__left">
                <nav class="ps-main-menu">
                    <ul class="menu">
                                ...
                                <div class="container">
                                    ...
                                    <div class="ps-branch">
                                        ...
                                        <div class="ps-branch__box">
                                            <div class="ps-branch__item"><a href="#"><img
                                                        src="img/branch/brand-1.jpg" alt="alt"></a></div>
                                            <div class="ps-branch__item"><a href="#"><img
                                                        src="img/branch/brand-2.jpg" alt="alt"></a></div>
                                            <div class="ps-branch__item"><a href="#"><img
                                                        src="img/branch/brand-3.jpg" alt="alt"></a></div>
                                            <div class="ps-branch__item"><a href="#"><img
                                                        src="img/branch/brand-4.jpg" alt="alt"></a></div>
                                            <div class="ps-branch__item"><a href="#"><img
                                                        src="img/branch/brand-5.jpg" alt="alt"></a></div>
                                            <div class="ps-branch__item"><a href="#"><img
                                                        src="img/branch/brand-6.jpg" alt="alt"></a></div>
                                            <div class="ps-branch__item"><a href="#"><img
                                                        src="img/branch/brand-7.jpg" alt="alt"></a></div>
                                            <div class="ps-branch__item"><a href="#"><img
                                                        src="img/branch/brand-8.jpg" alt="alt"></a></div>
                                            <div class="ps-branch__item"><a href="#"><img
                                                        src="img/branch/brand-9.jpg" alt="alt"></a></div>
                                            <div class="ps-branch__item"><a href="#"><img
                                                        src="img/branch/brand-10.jpg" alt="alt"></a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="ps-promo">
                                                <div class="ps-promo__item"><img class="ps-promo__banner"
                                                    ...
                                                    <div class="ps-promo__content"><span
                                                        ...
                                                        <h4 class="mb-20 ps-promo__name">Get rid of bacteria <br>in
                                                            your home</h4><a class="ps-promo__btn"
                        ...
                        <li class="has-mega-menu"><a href="#"> Homepages<span class="sub-toggle"><i
                                        class="fa fa-chevron-down"></i></span></a>
                            <div class="mega-menu">
                                <div class="container">
                                    <div class="mega-menu__widget">
                                        <ul class="sub-menu--image">
                                            <li> <a href="index.html"><img src="img/promotion/1.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 1</h3>
                                            </li>
                                            <li> <a href="home2.html"><img src="img/promotion/2.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 2</h3>
                                            </li>
                                            <li> <a href="home3.html"><img src="img/promotion/3.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 3</h3>
                                            </li>
                                            <li> <a href="home4.html"><img src="img/promotion/4.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 4</h3>
                                            </li>
                                            <li> <a href="home5.html"><img src="img/promotion/5.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 5</h3>
                                            </li>
                                            <li> <a href="home6.html"><img src="img/promotion/6.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 6 Masks</h3>
                                            </li>
                                            <li> <a href="home7.html"><img src="img/promotion/7.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 7 One product</h3>
                                            </li>
                                            <li> <a href="home8.html"><img src="img/promotion/8.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 8</h3><span class="has-badge">New</span>
                                            </li>
                                            <li> <a href="home9.html"><img src="img/promotion/9.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 9</h3><span class="has-badge">New</span>
                                            </li>
                                            <li> <a href="home10.html"><img src="img/promotion/10.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 10</h3><span class="has-badge">New</span>
                                            </li>
                                            <li> <a href="home11.html"><img src="img/promotion/11.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 11</h3><span class="has-badge">New</span>
                                            </li>
                                            <li> <a href="home12.html"><img src="img/promotion/12.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 12</h3><span class="has-badge">New</span>
                                            </li>
                                            <li> <a href="home13.html"><img src="img/promotion/13.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 13</h3><span class="has-badge">New</span>
                                            </li>
                                            <li> <a href="home14.html"><img src="img/promotion/14.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 14</h3><span class="has-badge">New</span>
                                            </li>
                                            <li> <a href="home15.html"><img src="img/promotion/15.jpg"
                                                        alt="alt"></a>
                                                <h3 class="image-title">Home 15</h3><span class="has-badge">New</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <li class="has-mega-menu"><a href="category-list.html">Shop</a></li>
                        ...
                        <li class="has-mega-menu"><a href="#"> Collection<span class="sub-toggle"><i
                                        class="fa fa-chevron-down"></i></span></a>
                            <div class="mega-menu">
                                <div class="container">
                                    <div class="mega-menu__row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6 col-lg-3">
                                                        <div class="ps-product ps-product--standard">
                                                            <div class="ps-product__thumbnail"><a
                                                                    ...
                                                                    <figure><img src="img/products/054.jpg"
                                                                            alt="alt"><img
                                                            ...
                                                            <div class="ps-product__content">
                                                                <h5 class="ps-product__title"><a
                                                                        href="product1.html">Somersung Sonic X2000 Pro
                                                                        Black</a></h5>
                                                                <div class="ps-product__meta"><span
                                                    ...
                                                    <div class="col-12 col-sm-6 col-lg-3">
                                                        <div class="ps-product ps-product--standard">
                                                            <div class="ps-product__thumbnail"><a
                                                                    class="ps-product__image" href="product1.html">
                                                                    <figure><img src="img/products/028.jpg"
                                                                            alt="alt"><img
                                                    ...
                                                    <div class="col-12 col-sm-6 col-lg-3">
                                                        <div class="ps-product ps-product--standard">
                                                            <div class="ps-product__thumbnail"><a
                                                                    class="ps-product__image" href="product1.html">
                                                                    <figure><img src="img/products/016.jpg"
                                                                            alt="alt"><img
                                                            ...
                                                            <div class="ps-product__content">
                                                                <h5 class="ps-product__title"><a
                                                                        href="product1.html">Oxygen concentrator model
                                                                        KTS-5000</a></h5>
                                                                <div class="ps-product__meta"><span
                                                    ...
                                                    <div class="col-12 col-sm-6 col-lg-3">
                                                        <div class="ps-product ps-product--standard">
                                                            <div class="ps-product__thumbnail"><a
                                                                    class="ps-product__image" href="product1.html">
                                                                    <figure><img src="img/products/002.jpg"
                                                                            alt="alt"><img
                                                            ...
                                                            <div class="ps-product__content">
                                                                <h5 class="ps-product__title"><a
                                                                        href="product1.html">Blue Hot Water Bottle, 2
                                                                        Quart Capacity</a></h5>
                                                                <div class="ps-product__meta"><span
                                                                        class="ps-product__price sale">$38.39</span><span
                        ...
                        <li class="has-mega-menu"><a href="/create/post">create Blog</a></li>
...
<header class="ps-header ps-header--1 ps-header--mobile">
    ...
    <div class="ps-header__middle">
        <div class="container">
            ...
            <div class="ps-header__right">
                <ul class="ps-header__icons">
                    <li><a class="ps-header__item open-search" href="#"><i class="fa fa-search"></i></a>
                    </li>
                </ul>
            </div>
        </div>
